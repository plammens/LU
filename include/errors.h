...
class MatrixError : public virtual BaseException {
public:
    static constexpr auto base = "invalid value";
    explicit MatrixError(const char *specific = nullptr) : BaseException(base, specific) {}
};


/// Indicates that an algorithm encountered a singular matrix
class SingularMatrixError : public virtual MatrixError {
public:
...
class ValueError : public virtual BaseException {
public:
    static constexpr auto base = "invalid value";
    explicit ValueError(const char *specific = nullptr) : BaseException(base, specific) {}
};

class IOError : public virtual BaseException {
public:
...
class BadFormat : public virtual BaseException {
public:
